    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (OldPassword.isEmpty() || OldPassword == null) {
            ...
            RequestDispatcher requestDispatcher = request
                    .getRequestDispatcher("/WEB-INF/views/user/Updateinformation.jsp");
            try {
                requestDispatcher.forward(request, response);
            } catch (Exception e) {
                e.printStackTrace();
        ...
        // lastName = user.getLastName();
        // password = user.getPassword();
        // request.setAttribute("passwordAgain", "Please enter your new password
        // again");
        // user.setUsername(username);
        // user.setFirstName(firstName);
        // user.setLastName(lastName);
        ...
        // request.getRequestDispatcher("/WEB-INF/views/user/Updateinformation.jsp");
        // try {
        // requestDispatcher.forward(request, response);
        // } catch (Exception e) {
        // e.printStackTrace();
        ...
        // lastName = user.getLastName();
        // password = user.getPassword();
        // request.setAttribute("passwordDiff", "The new password is different. Please
        // check again.");
        // user.setUsername(username);
        // user.setFirstName(firstName);
        // user.setLastName(lastName);
