...
@WebServlet(name = "ViewBookingRateInEquipmentServlet", value = "/analytics/viewEquipment")
public class ViewBookingRateInEquipmentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int equipment_id = Integer.parseInt(req.getParameter("id"));
        ...
        try {
            ...
            BookingRate bookingRate = analyticsManager.getBookingRateInEquipment(equipment_id, startOfDay, endOfDay);
            req.setAttribute("bookingRate", gson.toJson(bookingRate));
        } catch (ParseException | SQLException | ClassNotFoundException e) {
            throw new RuntimeException(e);
        }

        req.getRequestDispatcher("/WEB-INF/views/analytics/bookingRateInEquipmentView.jsp").forward(req, resp);
    }
}
