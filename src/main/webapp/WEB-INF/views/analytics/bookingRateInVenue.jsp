...
<head>
    ...
    <script>
        function search(event) {
            ...
            location.href = '${pageContext.request.contextPath}/analytics/viewVenue?id=' + id + '&start_date=' + start_date + '&end_date=' + end_date
        }
    </script>
</head>
...
<div>
    <h1>booking rate of selected venue </h1>
    <form action="" onsubmit="return search(event)">
        ...
        <label for="id">Select a Venue</label>
